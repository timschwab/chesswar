...
import { CarryingMessagePayload } from "../../../../common/message-types/server.ts";
...
export class CarryingChessboardRenderer {
    ...
    render(teamBoard: ChessBoard, carrying: CarryingMessagePayload) {
